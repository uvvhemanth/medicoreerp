...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: Entry[] = [
    ...
    { path: "/solutions/diagnostic-lab-management-software", priority: 0.95 },
    { path: "/solutions/pharmacy-management-software", priority: 0.95 },
    { path: "/solutions/enterprise-healthcare-erp", priority: 0.95 },
    { path: "/solutions/government-payer-management", priority: 0.95 },
    ...
    { path: "/security/encryption", priority: 0.75 },
    { path: "/security/access-control", priority: 0.75 },
    { path: "/security/audit-trails", priority: 0.75 },
    { path: "/security/data-residency", priority: 0.75 },
