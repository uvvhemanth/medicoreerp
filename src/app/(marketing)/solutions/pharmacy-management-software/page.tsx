...
import { PHARMACY_LANDING } from "@/lib/content/marketing";
  ...
  return (
    <>
      <JsonLd
        data={[
          breadcrumbJsonLd([
            ...
            { name: "Pharmacy Management Software", path: PAGE.seo.canonical },
          ]),
          faqJsonLd(PAGE.faqs),
        ]}
      />
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Button asChild size="lg" variant="outline">
                  <Link href="/product/pharmacy">Explore pharmacy</Link>
                </Button>
              </div>
              <p className="mt-6 flex items-center gap-1.5 text-base text-muted">
                <Star className="h-4 w-4 fill-warning text-warning" />
                Closed-loop prescription-to-dispensing with a unified stock ledger
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
      ...
      <Section muted>
        <SectionHeading
          center
          eyebrow="Pharmacy modules"
          title="From Prescription to Stock, in One Ledger"
          subtitle="Verification, dispensing, batches, expiry, procurement and billing stay connected across hospital, retail and ward pharmacies."
          className="mb-14"
        />
      ...
      <Section>
        <SectionHeading center eyebrow="Pharmacy FAQs" title="Questions pharmacy teams ask before they switch" className="mb-12" />
        <FAQ items={PAGE.faqs} />
      </Section>

      <CTABand
        title="Ready to connect dispensing and stock?"
        subtitle="Looking for Pharmacy Management Software in Hyderabad? Book a demo to see how MedicoreERP connects prescriptions, dispensing, inventory, batch, expiry, procurement and billing."
      />
    </>
  );
}
