...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/resources/blog/${p.slug}` },
    openGraph: { title: p.title, description: p.excerpt, images: [p.image], type: "article" },
  };
}
    ...
    <>
      ...
      <article className="container-page max-w-3xl py-12">
        ...
        <div className="prose mt-8 space-y-5 text-lg leading-relaxed text-body">
          ...
          <p>MedicoreERP takes the opposite view: usability is the moat. When a system is genuinely fast and pleasant to use, adoption follows, data quality improves, and every downstream metric — from documentation time to denial rates — moves in the right direction.</p>
